...
Component.prototype.intent = function( intentName, handler, finalHandler ){
  ...
  if( !intentFilter ){
    this._intentFilters[intentName] = new Operation(handler, finalHandler, false)
  }
  return this
}
/**
...
Component.prototype.attempt = function( intentName, handler, finalHandler ){
  var intentFilter = this._intentFilters[intentName]
  if( !intentFilter ){
    this._intentFilters[intentName] = new Operation(handler, finalHandler, true)
  }
  return this
}
/**
 ...
 * */
Component.prototype.publish = Component.prototype.broadcast = function( channel ){
 ...
 * It also creates the channel if it doesn't exists yet.
 * */
Component.prototype.subscribeOnce = Component.prototype.peek = function( channel, listener ){
