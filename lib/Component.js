...
function Component( name, parent ){
  ...
  Object.defineProperty(this, "_componentList", {
    value: []
  })
...
Component.prototype.relay = function( name, data, finalCallback ){
  ...
  transmission.handleService(this._services[name], this)
  ...
  while( ++i < l ){
    ...
    // handle local root
    transmission.handleService(component._services[name], component)
