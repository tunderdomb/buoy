 ...
 * */
Component.prototype.invoke = Component.prototype.invokeService = function( serviceName ){
 ...
 * */
Component.prototype.lazy =
Component.prototype.invokeLazy =
Component.prototype.lazyInvokeService = function( serviceName ){
  var args = [].slice.call(arguments, 1)
  var rootComponent = root(this)
 ...
 * */
Component.prototype.relay =
Component.prototype.relayIntent = function( name, data, finishedCallback ){
 ...
 * */
Component.prototype.bubble =
Component.prototype.throw =
Component.prototype.throwIntent =
 ...
 * */
Component.prototype.provoke =
Component.prototype.induce =
Component.prototype.induceIntent =
Component.prototype.provokeIntent = function( intentName, data ){
 ...
 * */
Component.prototype.channel = function( channel ){
 ...
 * */
Component.prototype.channelExists = function( channel ){
  return this._channels.hasOwnProperty(channel)
}
/**
 * Delete a channel.
 * */
Component.prototype.deleteChannel = function( channel ){
 ...
 * */
Component.prototype.hasSubscribers = function( channel ){
 ...
 * If the channel doesn't exists it's `false`.
 * */
Component.prototype.isSubscribed = function( channel, listener ){
  return this.channelExists(channel) && channel.isSubscribed(listener)
}
/**
 * Publish/broadcast arguments on a channel.
 * If the channel doesn't exists nothing happens.
 * */
Component.prototype.broadcast =
Component.prototype.publish = function( channel ){
 ...
 * */
Component.prototype.subscribe = function( channel, listener ){
 ...
 * If the channel doesn't exists nothing happens.
 * */
Component.prototype.unsubscribe = function( channel, listener ){
  if( this.channelExists(channel) ) {
 ...
 * It also creates the channel if it doesn't exists yet.
 * */
Component.prototype.peek =
Component.prototype.subscribeOnce =
Component.prototype.peekChannel = function( channel, listener ){
...
Component.prototype.emptyChannel = function( channel ){
  if( this.channelExists(channel) ) {
